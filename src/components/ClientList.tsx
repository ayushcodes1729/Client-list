        ...
        <div className="p-3 sm:p-6 space-y-4 sm:space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0">
                <nav className="w-full sm:w-auto overflow-x-auto">
                    <ul className="flex gap-6 font-semibold text-gray-500 whitespace-nowrap">
                ...
                <div className="flex items-center space-x-2 w-full sm:w-auto justify-end">
                    ...
                    <div className="relative">
                        ...
                        <div
                            className={
                                open
                                    ? `absolute block z-10 right-0 mt-2 w-[calc(100vw-3rem)] sm:w-80 bg-white border rounded shadow-md p-4 space-y-3 text-sm`
                                    : `absolute hidden z-10 right-0 mt-2 w-[calc(100vw-3rem)] sm:w-80 bg-white border rounded shadow-md p-4 space-y-3 text-sm`
                            }
                        >
                                        ...
                                        >
                                            <div className="flex items-center gap-2">
                                                ...
                                                <div className="flex-1 ml-1">
                                                    ...
                                                    <span>
                                                        {getSortTypeName(config.type)}: {getSortDirectionName(config.type, config.direction)}
                                                    </span>
                                                </div>
                                            </div>
                                            <button
                            ...
                            <div>
                                <label className="flex justify-between items-center">
                                    Client Name
                                    <span className="space-x-1 flex flex-wrap gap-1 justify-end">
                                        <button
            ...
            <div className="border border-gray-200 rounded-xl flex flex-col gap-4 px-4">
                <div
                    className="hidden md:grid gap-4 font-semibold py-2 px-2 border-b border-gray-200"
                ...
                {sortedClients.map((client) => (
                    <>
                        <div
                            key={client.id}
                            className="hidden md:grid gap-4 items-center border-b border-gray-200 py-2 text-sm"
                            style={{ gridTemplateColumns: "1fr 1fr 1.5fr 1fr 1fr 1fr" }}
                        >
                        ...
                        {/* Mobile view */}
                        <div className="md:hidden flex flex-col p-4 border-b border-gray-200">
                            <div className="flex justify-between mb-2">
                                <div className="font-medium">Client #{client.id}</div>
                                <span className="px-2 py-1 bg-green-100 text-green-800 rounded text-xs">{client.status}</span>
                            </div>
                            <div className="mb-1">
                            ...
                            <div className="mb-1 text-xs text-gray-500">
                                <span className="font-medium">Created:</span> {client.createdAt.toLocaleString()}
                            </div>
                            <div className="text-xs text-gray-500">
                                <span className="font-medium">Updated:</span> {client.updatedAt.toLocaleString()}
                            </div>
                        </div>
                    </>
                ))}
